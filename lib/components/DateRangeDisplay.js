...
function DateRangeDisplay(props) {
  var startDate = props.startDate,
      ...
      format = props.format;
  return /*#__PURE__*/_react["default"].createElement("div", (0, _reactWithStyles.css)(styles.DateRangeDisplay), /*#__PURE__*/_react["default"].createElement(_DateDisplay["default"], {
    date: startDate,
    dateId: startDateId,
    ...
    align: "left",
    format: format
  }), /*#__PURE__*/_react["default"].createElement("div", (0, _reactWithStyles.css)(styles.DateRangeDisplay_arrow), /*#__PURE__*/_react["default"].createElement(_RightArrow["default"], (0, _reactWithStyles.css)(styles.DateRangeDisplay_arrow_svg, styles.DateRangeDisplay_arrow_svg__small))), /*#__PURE__*/_react["default"].createElement(_DateDisplay["default"], {
    date: endDate,
    dateId: endDateId,
