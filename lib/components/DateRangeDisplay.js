...
exports['default'] = (0, _reactWithStyles.withStyles)(function (_ref) {
  ...
  return {
    ...
    DateRangeDisplay_arrow: (_DateRangeDisplay_arr = {
      ...
      textAlign: 'center',
      borderRadius: '50%'
    }, _defineProperty(_DateRangeDisplay_arr, 'marginTop', '-5px'), _defineProperty(_DateRangeDisplay_arr, 'backgroundColor', '#ECECEC'), _defineProperty(_DateRangeDisplay_arr, 'position', 'absolute'), _defineProperty(_DateRangeDisplay_arr, 'top', 'calc(50% - 15px)'), _defineProperty(_DateRangeDisplay_arr, 'left', 'calc(50% - 15px)'), _DateRangeDisplay_arr),
