  ...
  _createClass(DateDisplay, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", _extends({
        ...
        className: 'day'
      }, (0, _reactWithStyles.css)(styles.DateDisplay_Day)), this.getDate("DD")), _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.DateDisplay_MonthYearDowWrapper), _react["default"].createElement("div", _extends({
        className: 'monthDisplay yearDisplay'
      }, (0, _reactWithStyles.css)(styles.DateDisplay_MonthYear)), this.getDate("MMMM YYYY")), _react["default"].createElement("div", _extends({
