...
function (_React$Component) {
  ...
  function TimePicker(props) {
    ...
    _this.onIncrement = _this.onIncrement.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onDecrement = _this.onDecrement.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.toogleMeridiem = _this.toogleMeridiem.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(TimePicker, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.TimePicker), _react["default"].createElement("div", _extends({
        className: "hour"
      }, (0, _reactWithStyles.css)(styles.TimePicker_toggleContainer, styles.TimePicker_separator)), _react["default"].createElement("button", _extends({
        className: "time-toogle increment hour-toogle",
        onClick: function onClick() {
          return _this2.onIncrement('hour');
        }
      }, (0, _reactWithStyles.css)(styles.TimePicker_toggle)), _react["default"].createElement(_ChevronUp["default"], null)), _react["default"].createElement("input", _extends({
        type: "text",
        value: hour.value,
      ...
      }, hourProps, (0, _reactWithStyles.css)(styles.TimePicker_input))), _react["default"].createElement("button", _extends({
        className: "time-toogle decrement hour-toogle",
        onClick: function onClick() {
          return _this2.onDecrement('hour');
        }
      }, (0, _reactWithStyles.css)(styles.TimePicker_toggle)), _react["default"].createElement(_ChevronDown["default"], null))), _react["default"].createElement("div", _extends({
        className: "min"
      }, (0, _reactWithStyles.css)(styles.TimePicker_toggleContainer, !is24HourFormat && styles.TimePicker_separator, disableMinutes && styles.TimePicker_isdisabled)), !disableMinutes && _react["default"].createElement("button", _extends({
      ...
      }, (0, _reactWithStyles.css)(styles.TimePicker_input, disableMinutes && styles.TimePicker_inputIsDisabled))), !disableMinutes && _react["default"].createElement("button", _extends({
        className: "time-toogle decrement min-toogle",
        onClick: function onClick() {
          return _this2.onDecrement('minute');
        }
      }, (0, _reactWithStyles.css)(styles.TimePicker_toggle)), _react["default"].createElement(_ChevronDown["default"], null))), !is24HourFormat && _react["default"].createElement("div", _extends({
        className: "mediterian"
      }, (0, _reactWithStyles.css)(styles.TimePicker_appm_wrapper)), _react["default"].createElement("button", _extends({
