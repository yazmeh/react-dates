...
exports.PureDateTimeRangePicker = undefined;
...
var _DateTimeRangePickerShape = require('../shapes/DateTimeRangePickerShape');

var _DateTimeRangePickerShape2 = _interopRequireDefault(_DateTimeRangePickerShape);
...
var _SingleDateRangeController = require('./SingleDateRangeController');

var _SingleDateRangeController2 = _interopRequireDefault(_SingleDateRangeController);
...
var _DayTimePickerRangeController = require('./DayTimePickerRangeController');

var _DayTimePickerRangeController2 = _interopRequireDefault(_DayTimePickerRangeController);
...
var propTypes = (0, _object2['default'])({}, _reactWithStyles.withStylesPropTypes, _DateTimeRangePickerShape2['default']);
...
var defaultProps = {
  ...
  isOutsideRange: function () {
    function isOutsideRange(day) {
      return !isInclusivelyBeforeDay(day, (0, _moment2['default'])());
    }
...
var DateTimeRangePicker = function (_React$Component) {
  ...
  _createClass(DateTimeRangePicker, [{
    ...
    key: 'dateChange',
    value: function () {
      function dateChange(_ref) {
        var startDate = _ref.startDate,
            endDate = _ref.endDate;

        if (startDate && endDate) {
          this.setState((0, _object2['default'])({}, this.state, { selected: { startDate: startDate, endDate: endDate } }));
        }
    ...
    value: function () {
      function renderDayPicker() {
        var _props6 = this.props,
            ...
            isDateRangePickerInputFocused = _props6.isDateRangePickerInputFocused,
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'div',
            (0, _reactWithStyles.css)(styles.DateTimeRangePicker_pickerWrapper),
            _react2['default'].createElement(
              'div',
              (0, _reactWithStyles.css)(styles.DateTimeRangePicker_pickerWrapperInner),
              _react2['default'].createElement(_DateRangeDisplayController2['default'], {
                startDate: selected.startDate,
                startDateId: startDateId,
                isStartDateFocused: focusedInput === _constants.START_DATE,
                endDate: selected.endDate,
              ...
              _react2['default'].createElement(_DayTimePickerRangeController2['default'], {
            ...
            !!(onApply || onCancel) && _react2['default'].createElement(
              'div',
              (0, _reactWithStyles.css)(styles.DateTimeRangePicker_ConfirmWrapper),
              !!onApply && _react2['default'].createElement(
                'button',
                _extends({
                  disabled: !startDate || !endDate,
                  onClick: function () {
                    function onClick() {
                      return onApply({ startDate: startDate, endDate: endDate });
                    }

                    return onClick;
                  }(),
                  tabIndex: 3
                }, (0, _reactWithStyles.css)(styles.DateTimeRangePicker_Apply, styles.DateTimeRangePicker_ConfirmButton)),
                'OK'
              ),
              !!onCancel && _react2['default'].createElement(
                ...
                _extends({
                  ...
                  onClick: function () {
                    function onClick() {
                      return onCancel({ startDate: startDate, endDate: endDate });
                    }

                    return onClick;
                  }(),
                  tabIndex: 4
                }, (0, _reactWithStyles.css)(styles.DateTimeRangePicker_Cancel, styles.DateTimeRangePicker_ConfirmButton)),
                'Cancel'
              )
            ),
            withFullScreenPortal && _react2['default'].createElement(
              'button',
              _extends({}, (0, _reactWithStyles.css)(styles.DateTimeRangePicker_closeButton), {
                type: 'button',
    ...
    value: function () {
      function render() {
        ...
        return _react2['default'].createElement(
          ...
          }, (0, _reactWithStyles.css)(styles.DateTimeRangePicker, block && styles.DateTimeRangePicker__block)),
          _react2['default'].createElement(
            _OutsideClickHandler2['default'],
            { onOutsideClick: onOutsideClick },
            _react2['default'].createElement(_SingleDateRangeController2['default'], {
              startDate: selected.startDate,
              startDateId: startDateId,
...
exports['default'] = (0, _reactWithStyles.withStyles)(function (_ref2) {
  ...
  return {
    ...
    DateTimeRangePicker_ConfirmButton: {
      ...
      minWidth: String(sizing.confirmButtonMinWidth) + 'px',
      border: 0,
      marginRight: '10px',
      fontWeight: 800,
      borderRadius: '5px',
