...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)(_objectSpread(_objectSpread(_objectSpread({}, _reactWithStyles.withStylesPropTypes), _DateTimeRangePickerShape["default"]), {}, {
  renderDateRangeDisplay: _propTypes["default"].func
})) : {};;
var defaultProps = {
...
var DateTimeRangePicker = /*#__PURE__*/function (_ref) {
  ...
  function DateTimeRangePicker(props) {
    ...
    _this.dateChange = _this.dateChange.bind(_assertThisInitialized(_this));
  ...
  _createClass(DateTimeRangePicker, [{
    ...
    value: function renderDayPicker() {
      var _this$props8 = this.props,
          ...
          _this$props8$selected = _this$props8.selected,
          selected = _this$props8$selected === void 0 ? {} : _this$props8$selected,
          renderDateRangeDisplay = _this$props8.renderDateRangeDisplay,
      ...
      var closeIcon = customCloseIcon || /*#__PURE__*/_react["default"].createElement(_CloseButton["default"], (0, _reactWithStyles.css)(styles.DateTimeRangePicker_closeButton_svg));
      ...
      }), /*#__PURE__*/_react["default"].createElement(_DayTimePickerRangeController["default"], {
      ...
      }), withFullScreenPortal && /*#__PURE__*/_react["default"].createElement("button", _extends({}, (0, _reactWithStyles.css)(styles.DateTimeRangePicker_closeButton), {
        type: "button",
    ...
    value: function render() {
      ...
      var input = /*#__PURE__*/_react["default"].createElement(_SingleDateRangeController["default"], {
      ...
      }, (0, _reactWithStyles.css)(styles.DateTimeRangePicker, block && styles.DateTimeRangePicker__block)), enableOutsideClick && /*#__PURE__*/_react["default"].createElement(_reactOutsideClickHandler["default"], {
