...
exports["default"] = exports.PureSingleDateTimePicker = void 0;
...
var _DayPickerSingleDateTimeController = _interopRequireDefault(require("./DayPickerSingleDateTimeController"));
...
var SingleDateTimePicker = /*#__PURE__*/function (_ref) {
  _inherits(SingleDateTimePicker, _ref);

  var _super = _createSuper(SingleDateTimePicker);

  function SingleDateTimePicker(props) {
    var _this;

    _classCallCheck(this, SingleDateTimePicker);
  ...
  _createClass(SingleDateTimePicker, [{
    ...
    value: function disableScroll() {
      ...
      if (!focused) return; // Disable scroll for every ancestor of this <SingleDateTimePicker> up to the
    ...
    value: function renderDayPicker() {
      var _this$props6 = this.props,
          ...
          is24HourFormat = _this$props6.is24HourFormat,
          hideTime = _this$props6.hideTime,
          disableMinutes = _this$props6.disableMinutes,
      ...
      }, (0, _reactWithStyles.css)(styles.SingleDateTimePicker_picker, anchorDirection === _constants.ANCHOR_LEFT && styles.SingleDateTimePicker_picker__directionLeft, anchorDirection === _constants.ANCHOR_RIGHT && styles.SingleDateTimePicker_picker__directionRight, openDirection === _constants.OPEN_DOWN && styles.SingleDateTimePicker_picker__openDown, openDirection === _constants.OPEN_UP && styles.SingleDateTimePicker_picker__openUp, !withAnyPortal && openDirection === _constants.OPEN_DOWN && {
        top: inputHeight + verticalSpacing
      }, !withAnyPortal && openDirection === _constants.OPEN_UP && {
        bottom: inputHeight + verticalSpacing
      }, orientation === _constants.HORIZONTAL_ORIENTATION && styles.SingleDateTimePicker_picker__horizontal, orientation === _constants.VERTICAL_ORIENTATION && styles.SingleDateTimePicker_picker__vertical, withAnyPortal && styles.SingleDateTimePicker_picker__portal, withFullScreenPortal && styles.SingleDateTimePicker_picker__fullScreenPortal, isRTL && styles.SingleDateTimePicker_picker__rtl, dayPickerContainerStyles), {
        onClick: onOutsideClick
      }), /*#__PURE__*/_react["default"].createElement(_DayPickerSingleDateTimeController["default"], {
      ...
      }), withFullScreenPortal && /*#__PURE__*/_react["default"].createElement("button", _extends({}, (0, _reactWithStyles.css)(styles.SingleDateTimePicker_closeButton), {
        "aria-label": phrases.closeDatePicker,
        type: "button",
        onClick: this.onOutsideClick
      }), /*#__PURE__*/_react["default"].createElement("div", (0, _reactWithStyles.css)(styles.SingleDateTimePicker_closeButton_svg), closeIcon)));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, (0, _reactWithStyles.css)(styles.SingleDateTimePicker, block && styles.SingleDateTimePicker__block)), enableOutsideClick && /*#__PURE__*/_react["default"].createElement(_reactOutsideClickHandler["default"], {
...
exports.PureSingleDateTimePicker = SingleDateTimePicker;
SingleDateTimePicker.propTypes = process.env.NODE_ENV !== "production" ? propTypes : {};
