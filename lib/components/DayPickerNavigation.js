...
function DayPickerNavigation(_ref) {
  ...
  if (!navPrevIcon) {
    ...
    navPrevIcon = _react2['default'].createElement(Icon, (0, _reactWithStyles.css)(isHorizontal && styles.DayPickerNavigation_svg__horizontal, isVertical && styles.DayPickerNavigation_svg__vertical, disablePrev && styles.DayPickerNavigation_svg__disabled));
  }
  ...
  if (!navNextIcon) {
    ...
    navNextIcon = _react2['default'].createElement(_Icon, (0, _reactWithStyles.css)(isHorizontal && styles.DayPickerNavigation_svg__horizontal, isVertical && styles.DayPickerNavigation_svg__vertical, disableNext && styles.DayPickerNavigation_svg__disabled));
  }
...
exports['default'] = (0, _reactWithStyles.withStyles)(function (_ref2) {
  ...
  return {
    ...
    DayPickerNavigation_button__disabled: {
      cursor: "default",
      border: '1px solid ' + String(color.disabled),
