...
var propTypes = process.env.NODE_ENV !== "production" ? _objectSpread({}, (0, _omit["default"])(_DateRangePickerShape["default"], ['startDate', 'endDate', 'onDatesChange', 'focusedInput', 'onFocusChange']), {
...
function (_React$Component) {
  ...
  function DateTimePickerComponent(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DateTimePickerComponent).call(this, props));
    ...
    _this.onPresetSelect = _this.onPresetSelect.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.generatePresetOption = _this.generatePresetOption.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onApply = _this.onApply.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(DateTimePickerComponent, [{
    ...
    value: function generatePresetOption() {
      ...
      if (presetOptions) {
        return _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.PresetOptionMenu_Wrapper), _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.DateTimePickerComponent_menu), _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.PresetOptionMenu), presetTime && _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.PresetOptionMenu_item_time), _react["default"].createElement("div", null, "Latest Hour"), _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.PresetTime_Menu), presetTime.map(function (_ref2) {
          var text = _ref2.text,
              start = _ref2.start,
              end = _ref2.end;
          var isSelected = (0, _isSameHour["default"])(start, startDate) && (0, _isSameHour["default"])(end, endDate);
          return _react["default"].createElement("span", (0, _reactWithStyles.css)(styles.PresetTime_Menu_Item, isSelected && styles.PresetTime_Menu_Item_selected), _react["default"].createElement("button", {
        ...
        })), !!(this.onApply || this.onCancel) && _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.DateTimeRangePicker_ConfirmWrapper), !!this.onApply && _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.DateTimePickerComponent_ConfirmButton_Wrapper), _react["default"].createElement("button", _extends({
          ...
          tabIndex: 3
        }, (0, _reactWithStyles.css)(styles.DateTimePickerComponent_Apply, styles.DateTimePickerComponent_ConfirmButton)), "Apply")), !!this.onCancel && _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.DateTimePickerComponent_ConfirmButton_Wrapper), _react["default"].createElement("button", _extends({
          disabled: !startDate || !endDate,
          onClick: function onClick() {
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", null, _react["default"].createElement(_DateTimeRangePicker["default"], _extends({}, props, {
        onDatesChange: this.onDatesChange,
        onFocusChange: this.onFocusChange,
