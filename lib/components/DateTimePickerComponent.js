...
var _isSameHour = require('../utils/isSameHour');

var _isSameHour2 = _interopRequireDefault(_isSameHour);
...
var propTypes = (0, _object2['default'])({}, (0, _omit2['default'])(_DateRangePickerShape2['default'], ['startDate', 'endDate', 'onDatesChange', 'focusedInput', 'onFocusChange']), {
  applyOnSelect: _propTypes2['default'].bool
...
var defaultProps = {
  ...
  isOutsideRange: function () {
    function isOutsideRange(day) {
      return !(0, _isInclusivelyAfterDay2['default'])(day, today);
    }
...
var DateTimePickerComponent = function (_React$Component) {
  ...
  _createClass(DateTimePickerComponent, [{
    ...
    value: function () {
      function generatePresetOption() {
        ...
        var _props = this.props,
            ...
            preOpt = _props.presetOptions,
            preTime = _props.presetTime,
            renderCalendarInfo = _props.renderCalendarInfo;
        var _state = this.state,
            startDate = _state.startDate,
            endDate = _state.endDate;

        var presetOptions = typeof preOpt === 'function' ? preOpt((0, _moment2['default'])()) : preOpt;
        var presetTime = typeof preTime === "function" ? preTime((0, _moment2['default'])()) : preTime;
        if (presetOptions) {
          return _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                presetTime && _react2['default'].createElement(
                  'div',
                  (0, _reactWithStyles.css)(styles.PresetOptionMenu_item_time),
                  _react2['default'].createElement(
                    'div',
                    null,
                    'Latest Hour'
                  ...
                  _react2['default'].createElement(
                    'div',
                    (0, _reactWithStyles.css)(styles.PresetTime_Menu),
                    presetTime.map(function (_ref2) {
                      var text = _ref2.text,
                          start = _ref2.start,
                          end = _ref2.end;

                      var isSelected = (0, _isSameHour2['default'])(start, startDate) && (0, _isSameHour2['default'])(end, endDate);
                      return _react2['default'].createElement(
                        'span',
                        (0, _reactWithStyles.css)(styles.PresetTime_Menu_Item, isSelected && styles.PresetTime_Menu_Item_selected),
                        _react2['default'].createElement(
                          'button',
                          { onClick: function () {
                              function onClick() {
    ...
    key: 'onDatesChange',
    value: function () {
      function onDatesChange(_ref4) {
        var startDate = _ref4.startDate,
            endDate = _ref4.endDate;
        var _props2 = this.props,
            stateDateWrapper = _props2.stateDateWrapper,
            applyOnSelect = _props2.applyOnSelect,
        ...
        if (applyOnSelect && !!startDate && !!endDate) {
          this.setState({
            selected: { startDate: startDate, endDate: endDate }
          });
          if (this.state.focusedInput === _constants.END_DATE) {
            this.onFocusChange(_constants.START_DATE);
          }
          if (onApply) {
            onApply({ startDate: startDate, endDate: endDate }, { startDate: this.state.startDate, endDate: this.state.endDate });
          }
        }
      }
    ...
    value: function () {
      function render() {
        var props = (0, _omit2['default'])(this.props, ["autoFocus", "autoFocusEndDate", "initialStartDate", "initialEndDate", "stateDateWrapper", "onApply", "onCancel", "selected", "startDate", "endDate", "presetOptions", "applyOnSelect", "applyOnPreset"]);
...
exports['default'] = (0, _reactWithStyles.withStyles)(function (_ref5) {
