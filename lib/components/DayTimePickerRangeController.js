...
var _DayTimePicker = require('./DayTimePicker');

var _DayTimePicker2 = _interopRequireDefault(_DayTimePicker);
...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  displayRangeProp: _propTypes2['default'].object,
  ...
  disableMinutes: _propTypes2['default'].bool,
  hideTime: _propTypes2['default'].bool,
...
var DayTimePickerRangeController = function (_React$Component) {
  _inherits(DayTimePickerRangeController, _React$Component);

  function DayTimePickerRangeController(props) {
    _classCallCheck(this, DayTimePickerRangeController);

    var _this = _possibleConstructorReturn(this, (DayTimePickerRangeController.__proto__ || Object.getPrototypeOf(DayTimePickerRangeController)).call(this, props));
    ...
    _this.state = {
      ...
      startTime: Boolean(startDate) && startDate || (0, _moment2['default'])('12:00', 'hh:mm'),
      endTime: Boolean(endDate) && endDate || (0, _moment2['default'])('12:00', 'hh:mm'),
  ...
  _createClass(DayTimePickerRangeController, [{
    ...
    value: function () {
      function shouldDisableMonthNavigation(date, visibleMonth) {
        ...
        return (0, _isDayVisible2['default'])(date, visibleMonth, numberOfMonths, enableOutsideDays);
      }
    ...
    value: function () {
      function componentWillReceiveProps(nextProps) {
        ...
        var _props2 = this.props,
            prevStartDate = _props2.startDate,
            prevEndDate = _props2.endDate,
            prevFocusedInput = _props2.focusedInput,
            prevMinimumNights = _props2.minimumNights,
            prevIsOutsideRange = _props2.isOutsideRange,
            prevIsDayBlocked = _props2.isDayBlocked,
            prevIsDayHighlighted = _props2.isDayHighlighted,
            prevPhrases = _props2.phrases,
            prevInitialVisibleMonth = _props2.initialVisibleMonth,
            prevNumberOfMonths = _props2.numberOfMonths,
            prevEnableOutsideDays = _props2.enableOutsideDays;
    ...
    key: 'onDayClick',
    value: function () {
      function onDayClick(selDay, e) {
        var _props3 = this.props,
            keepOpenOnDateSelect = _props3.keepOpenOnDateSelect,
            minimumNights = _props3.minimumNights,
            onBlur = _props3.onBlur,
            focusedInput = _props3.focusedInput,
            onFocusChange = _props3.onFocusChange,
            onClose = _props3.onClose,
            hideTime = _props3.hideTime,
            onDatesChange = _props3.onDatesChange,
            startDateOffset = _props3.startDateOffset,
            endDateOffset = _props3.endDateOffset,
        ...
        if (focusedInput === _constants.START_DATE) {
          ...
          day = hideTime ? selDay.clone().startOf('day') : selDay.clone().set({
        ...
        if (startDateOffset || endDateOffset) {
          startDate = (0, _getSelectedDateOffset2['default'])(startDateOffset, selDay);
          endDate = (0, _getSelectedDateOffset2['default'])(endDateOffset, selday);
    ...
    value: function () {
      function onDayMouseEnter(day) {
        ...
        var _props5 = this.props,
            ...
            startDateOffset = _props5.startDateOffset,
            endDateOffset = _props5.endDateOffset;
    ...
    key: 'onTimeChange',
    value: function () {
      function onTimeChange(time, type) {
        var _props9 = this.props,
            startDate = _props9.startDate,
            endDate = _props9.endDate,
            onDatesChange = _props9.onDatesChange;

        if (type === _constants.START_DATE) {
          this.setState((0, _object2['default'])({}, this.state, { startTime: time }));
          if (startDate) {
            var startDate1 = startDate.clone().hour(time.hour()).minute(time.minute());
            onDatesChange({ startDate: startDate1, endDate: endDate });
          }
        } else if (type === _constants.END_DATE) {
          this.setState((0, _object2['default'])({}, this.state, { endTime: time }));
          if (endDate) {
            var endDate1 = endDate.clone().hour(time.hour()).minute(time.minute());
            onDatesChange({ startDate: startDate, endDate: endDate1 });
          }
        }
      }
    ...
    value: function () {
      function getStateForNewMonth(nextProps) {
        ...
        var mid = (0, _getVisibleDays2['default'])(currentMonth, numberOfMonths, enableOutsideDays, withoutTransitionMonths);
        var visibleDays = this.getModifiers(mid);
    ...
    value: function () {
      function render() {
        var _props19 = this.props,
            ...
            renderMonth = _props19.renderMonth,
            navPrev = _props19.navPrev,
            is24HourFormat = _props19.is24HourFormat,
            ...
            disableMinutes = _props19.disableMinutes,
        ...
        var _state8 = this.state,
            ...
            disablePrev = _state8.disablePrev,
            disableNext = _state8.disableNext;


        return _react2['default'].createElement(
          'div',
          null,
          _react2['default'].createElement(_DayTimePicker2['default'], {
...
DayTimePickerRangeController.propTypes = propTypes;
