    ...
    value: function () {
      function onDayClick(selDay, e) {
        ...
        if (focusedInput === _constants.START_DATE) {
          ...
          day = hideTime ? selDay : selDay.clone().set({ hour: this.state.endTime.hour(), minute: this.state.endTime.minute() });
    ...
    value: function () {
      function render() {
        var _props18 = this.props,
            ...
            is24HourFormat = _props18.is24HourFormat,
            ...
            renderCalendarDay = _props18.renderCalendarDay,
            renderDayContents = _props18.renderDayContents,
            displayRangeProp = _props18.displayRangeProp,
            renderCalendarInfo = _props18.renderCalendarInfo,
            calendarInfoPosition = _props18.calendarInfoPosition,
            onBlur = _props18.onBlur,
            hideTime = _props18.hideTime,
            ...
            disableMinutes = _props18.disableMinutes,
            transitionDuration = _props18.transitionDuration,
            verticalBorderSpacing = _props18.verticalBorderSpacing;
