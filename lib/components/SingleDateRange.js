...
function (_React$Component) {
  ...
  function SingleDateRange() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SingleDateRange).apply(this, arguments));
  }
  ...
  _createClass(SingleDateRange, [{
    ...
    value: function render() {
      ...
      }, (0, _reactWithStyles.css)(styles.SingleDateRange, small ? styles.SingleDateRange_small : styles.SingleDateRange_normal)), inputDateTimeElement ? inputDateTimeElement(dateValues) : _react["default"].createElement("div", null, "".concat(startDate).concat(rangeSeparator).concat(endDate)), showDefaultInputIcon && _react["default"].createElement("div", (0, _reactWithStyles.css)(styles.SingleDateRange_calendarIcon), _react["default"].createElement(_CalendarIcon["default"], (0, _reactWithStyles.css)(styles.SingleDateRange_calendarIcon_svg))));
    }
  }]);
