...
function (_ref) {
  ...
  function DayTimePicker(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DayTimePicker).call(this, props));
  ...
  _createClass(DayTimePicker, [{
    ...
    value: function renderWeekHeader(index) {
      ...
      return _react["default"].createElement("div", _extends({}, (0, _reactWithStyles.css)(styles.DayTimePicker_weekHeader, this.isVertical() && styles.DayTimePicker_weekHeader__vertical, verticalScrollable && styles.DayTimePicker_weekHeader__verticalScrollable, weekHeaderStyle, {
        padding: "0 ".concat(horizontalMonthPadding, "px")
      }), {
        key: "week-".concat(index)
      }), _react["default"].createElement("ul", (0, _reactWithStyles.css)(styles.DayTimePicker_weekHeader_ul), header));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, (0, _reactWithStyles.css)(styles.DayTimePicker, isHorizontal && styles.DayTimePicker__horizontal, verticalScrollable && styles.DayTimePicker__verticalScrollable, isHorizontal && withPortal && styles.DayTimePicker_portal__horizontal, this.isVertical() && withPortal && styles.DayTimePicker_portal__vertical, DayTimePickerStyle, !monthTitleHeight && styles.DayTimePicker__hidden, !noBorder && styles.DayTimePicker__withBorder)), _react["default"].createElement(_reactOutsideClickHandler["default"], {
        onOutsideClick: onOutsideClick
      }, (calendarInfoPositionTop || calendarInfoPositionBefore) && calendarInfo, _react["default"].createElement("div", (0, _reactWithStyles.css)(DayTimePickerWrapperStyle, calendarInfoIsInline && isHorizontal && styles.DayTimePicker_wrapper__horizontal), !singleTime && _react["default"].createElement(_DateRangeDisplayController["default"], displayRangeProp), _react["default"].createElement("div", _extends({}, (0, _reactWithStyles.css)(styles.DayTimePicker_weekHeaders, isHorizontal && styles.DayTimePicker_weekHeaders__horizontal), {
        "aria-hidden": "true",
        role: "presentation"
      }), weekHeaders), _react["default"].createElement("div", _extends({}, (0, _reactWithStyles.css)(styles.DayTimePicker_focusRegion), {
      ...
      }), verticalScrollable && this.renderNavigation()), !hideTime && (!singleTime ? _react["default"].createElement("div", null, _react["default"].createElement(_TimeRangePicker["default"], {
      ...
      }))), !isTouch && !hideKeyboardShortcutsPanel && _react["default"].createElement(_DayPickerKeyboardShortcuts["default"], {
