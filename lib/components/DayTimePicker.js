...
var _DateRangeDisplayController = require('./DateRangeDisplayController');

var _DateRangeDisplayController2 = _interopRequireDefault(_DateRangeDisplayController);
...
var DayTimePicker = function (_React$Component) {
  _inherits(DayTimePicker, _React$Component);

  function DayTimePicker(props) {
    _classCallCheck(this, DayTimePicker);

    var _this = _possibleConstructorReturn(this, (DayTimePicker.__proto__ || Object.getPrototypeOf(DayTimePicker)).call(this, props));
    ...
    value: function () {
      function renderNavigation() {
        ...
        var _props5 = this.props,
            ...
            isRTL = _props5.isRTL,
            disablePrev = _props5.disablePrev,
            disableNext = _props5.disableNext;
      ...
      function renderWeekHeader(index) {
        ...
        for (var i = 0; i < 7; i += 1) {
          header.push(_react2['default'].createElement(
            'li',
            _extends({ key: i }, (0, _reactWithStyles.css)(styles.DayTimePicker_weekHeader_li, { width: daySize })),
        ...
        return _react2['default'].createElement(
          'div',
          _extends({}, (0, _reactWithStyles.css)(styles.DayTimePicker_weekHeader, this.isVertical() && styles.DayTimePicker_weekHeader__vertical, verticalScrollable && styles.DayTimePicker_weekHeader__verticalScrollable, weekHeaderStyle), {
            key: 'week-' + String(index)
          }),
          _react2['default'].createElement(
            'ul',
            (0, _reactWithStyles.css)(styles.DayTimePicker_weekHeader_ul),
            header
          )
        );
      }
    ...
    value: function () {
      function render() {
        ...
        var _props7 = this.props,
            ...
            onTimeChange = _props7.onTimeChange,
            ...
            is24HourFormat = _props7.is24HourFormat,
            startTime = _props7.startTime,
            singleTime = _props7.singleTime,
            endTime = _props7.endTime,
            displayRangeProp = _props7.displayRangeProp,
            hideKeyboardShortcutsPanel = _props7.hideKeyboardShortcutsPanel,
            disableMinutes = _props7.disableMinutes,
            hideTime = _props7.hideTime,
        ...
        var calendarInfo = renderCalendarInfo && _react2['default'].createElement(
          ...
          }, (0, _reactWithStyles.css)(calendarInfoIsInline && styles.DayTimePicker_calendarInfo__horizontal)),
          renderCalendarInfo()
        );
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              'div',
              (0, _reactWithStyles.css)(dayPickerWrapperStyle, calendarInfoIsInline && isHorizontal && styles.DayTimePicker_wrapper__horizontal),
              !singleTime && _react2['default'].createElement(_DateRangeDisplayController2['default'], displayRangeProp),
              _react2['default'].createElement(
                'div',
                _extends({}, (0, _reactWithStyles.css)(styles.DayTimePicker_weekHeaders, isHorizontal && styles.DayTimePicker_weekHeaders__horizontal), {
                  'aria-hidden': 'true',
                  role: 'presentation'
                }),
                weekHeaders
              ...
              _react2['default'].createElement(
                'div',
                _extends({}, (0, _reactWithStyles.css)(styles.DayTimePicker_focusRegion), {
                ...
                _react2['default'].createElement(
                  'div',
                  _extends({}, (0, _reactWithStyles.css)(styles.DayTimePicker_transitionContainer, isHorizontalAndAnimating && styles.DayTimePicker_transitionContainer__horizontal, this.isVertical() && styles.DayTimePicker_transitionContainer__vertical, verticalScrollable && styles.DayTimePicker_transitionContainer__verticalScrollable, transitionContainerStyle), {
                ...
                !hideTime && (!singleTime ? _react2['default'].createElement(
                  'div',
                  null,
                  _react2['default'].createElement(_TimeRangePicker2['default'], {
...
exports.PureDayPicker = DayTimePicker;
