...
function (_React$Component) {
  ...
  function SingleDateRangeController(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SingleDateRangeController).call(this, props));
  ...
  _createClass(SingleDateRangeController, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_SingleDateRange["default"], {
