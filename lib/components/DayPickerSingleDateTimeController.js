...
var DayPickerSingleDateTimeController = function (_React$Component) {
    _inherits(DayPickerSingleDateTimeController, _React$Component);

    function DayPickerSingleDateTimeController(props) {
        _classCallCheck(this, DayPickerSingleDateTimeController);

        var _this = _possibleConstructorReturn(this, (DayPickerSingleDateTimeController.__proto__ || Object.getPrototypeOf(DayPickerSingleDateTimeController)).call(this, props));
        ...
        _this.state = {
            ...
            time: Boolean(date) && date || (0, _moment2['default'])('12:00', 'hh:mm')
        };
    ...
    _createClass(DayPickerSingleDateTimeController, [{
        ...
        value: function () {
            function onTimeChange(time, type) {
                ...
                if (type) {
                    this.setState((0, _object2['default'])({}, this.state, { time: time }));
                    if (date) {
        ...
        value: function () {
            function deleteModifier(updatedDays, day, modifier) {
                var _props7 = this.props,
                    numberOfVisibleMonths = _props7.numberOfMonths,
        ...
        value: function () {
            function render() {
                var _props9 = this.props,
                    ...
                    renderMonth = _props9.renderMonth,
                    ...
                    showKeyboardShortcuts = _props9.showKeyboardShortcuts,
                    ...
                    hideTime = _props9.hideTime,
                    is24HourFormat = _props9.is24HourFormat,
                    disableMinutes = _props9.disableMinutes;
                var _state7 = this.state,
                    currentMonth = _state7.currentMonth,
                    visibleDays = _state7.visibleDays;


                return _react2['default'].createElement(_DayTimePicker2['default'], {
...
DayPickerSingleDateTimeController.propTypes = propTypes;
