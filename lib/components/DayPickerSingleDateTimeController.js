...
var DayPickerSingleDateTimeController =
/*#__PURE__*/
function (_ref) {
  ...
  function DayPickerSingleDateTimeController(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DayPickerSingleDateTimeController).call(this, props));
    ...
    _this.onTimeChange = _this.onTimeChange.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(DayPickerSingleDateTimeController, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_DayTimePicker["default"], {
