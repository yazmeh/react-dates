...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  // accessibility
  isFocused: _propTypes["default"].bool // i18n,
...
var DateRangeDisplayController =
/*#__PURE__*/
function (_React$Component) {
  ...
  function DateRangeDisplayController(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DateRangeDisplayController).call(this, props));
  ...
  _createClass(DateRangeDisplayController, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_DateRangeDisplay["default"], {
        startDate: startDate,
