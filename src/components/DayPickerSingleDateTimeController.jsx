...
export default class DayPickerSingleDateTimeController extends React.PureComponent {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            currentMonth,
            visibleDays,
            time: (Boolean(date) && date) || moment('12:00', 'hh:mm'),
        };
    ...
    onTimeChange(time, type) {
        ...
        if (type) {
            ...
            if (date) {
                const date1 = date.clone().hour(time.hour()).minute(time.minute());
                onDateChange(date1);
            }
        }
    }
